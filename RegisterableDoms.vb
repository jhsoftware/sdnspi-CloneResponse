Public Class RegisterableDomains
  ...
  Public Function Load(ByVal fileName As String) As Boolean
    ...
    While Not rdr.EndOfStream
      ...
      If x.Length = 0 Then Continue While
      If Not JHSoftware.SimpleDNS.Plugin.DomainName.TryParse(x, d) Then Continue While
  ...
  Public Function GetZoneLabelCount(ByVal d As JHSoftware.SimpleDNS.Plugin.DomainName) As Integer
  ...
  Class RuleList
    Private Domains As New Dictionary(Of JHSoftware.SimpleDNS.Plugin.DomainName, Object)
    Private Wildcards As New Dictionary(Of JHSoftware.SimpleDNS.Plugin.DomainName, Object)

    Friend Sub Add(ByVal d As JHSoftware.SimpleDNS.Plugin.DomainName, ByVal wild As Boolean)
      If wild Then
    ...
    Friend Function Contains(ByVal d As JHSoftware.SimpleDNS.Plugin.DomainName) As Boolean
